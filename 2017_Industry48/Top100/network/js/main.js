...
function showCluster(a) {
    ...
    if (b && 0 < b.length) {
		...
		else if (a == "rgb(255,183,176)"){
			$GP.info_name.html("<b>" + "Chips" + "</b>");
		}
		else if (a == "rgb(255,154,116)"){
